                           ...
                           <div class="carousel-inner">
                               ...
                               <div class="item" >
                                   <blockquote>
                                       <div class="row" style="height: 180px;">
                                           <div class="col-sm-3 text-center">
                                               <img class="img-circle" src="img/testimonials-2.png" style="width: 100px;height:100px;">
                                           </div>
                                           <div class="col-sm-9">
                               ...
                               <div class="item">
                                   <blockquote>
                                       <div class="row" style="height: 180px;">
                                           <div class="col-sm-3 text-center">
                                               <img class="img-circle" src="img/testimonials-3.png" style="width: 100px;height:100px;">
                                           </div>
                                           <div class="col-sm-9">
           ...
           <br>
               <div class="row">
                   <div class="col-xs-6 col-md-3">
                       <a href="#" >
                           <img src="img/home-bg.jpg" height="175" width="220" alt="...">
                       </a>
                      <p>jakgjakjgjajgjaogpjajgjajg</p>
                   </div>
                   <div class="col-xs-6 col-md-3">
                       <a href="#" >
                           <img src="img/home-bg.jpg" height="175" width="230" alt="...">
                       </a>
                       <p>jakgjakjgjajgjaogpjajgjajg</p>
                   </div>
                   <div class="col-xs-6 col-md-3">
