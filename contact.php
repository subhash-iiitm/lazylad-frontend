...
<body style="font-family: 'Roboto', sans-serif;">
    ...
    <div class="container-fluid" style="margin-top:88px;margin-left:142px;">
        <div class="row">
            ...
            <div style="margin-top:38px;"><textarea style="width:456px;height:237px;padding-left:20px;color:black;padding-top:20px;margin-left:-15px;" class="contact" id="cfmessage" name="cfmessage" placeholder="Text your message here"></textarea></div>
